...
export interface Store extends StoreRoot {
  ...
  readonly stockChartFilterCriteria: string;
  ...
  constructor() {
    ...
    this.createListener<SelectedInstrument>(
      ...
      (instrument: SelectedInstrument) => {
        if (!instrument) {
          ...
          this.stockChartFilterCriteria = undefined;
        ...
        this.tradesFilterCriteria = criteriaBuilder()
          ...
          .build();
        this.stockChartFilterCriteria = criteriaBuilder()
          .withExpression(
            expressionBuilder('INSTRUMENT_ID', instrument.INSTRUMENT_ID, Serialisers.EQ)
          )
          .build();
    ...
    this.createListener<string>(
      ...
      (criteria: string) => {
        ...
        this.stockChartFilterCriteria = criteria;
